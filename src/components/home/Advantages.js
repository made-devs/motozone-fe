        ...
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-tjm-yellow font-montserrat font-black text-xs tracking-[0.4em] uppercase">
                TJM Standards
              </span>
            </div>
            <h2 className="text-4xl md:text-6xl font-montserrat font-bold uppercase leading-none">
              STANDAR <span className="text-tjm-yellow">PRESISI</span> <br />
              LAYANAN KAMI.
            </h2>
          </div>
          <p className="text-gray-500 font-inter text-sm md:text-right max-w-[300px] italic">
            "Selesai Hari Ini, Presisi Selamanya." — Integritas dalam setiap
            detail komponen.
          </p>
        </div>

        <div className="grid lg:grid-cols-12 gap-0 border border-white/10 relative">
          {/* SIDEBAR NAVIGATION (Yellow & Bold) */}
          <div className="lg:col-span-4 flex flex-col bg-metallic-gray/10 backdrop-blur-md">
                ...
                <div className="flex items-center gap-6">
                  <span
                    className={`text-xl font-montserrat font-bold ${
                      activeTab === index ? "text-black" : "text-tjm-yellow/40"
                    }`}
                  >
                    {item.number}
                  </span>
          ...
          <div className="lg:col-span-8 relative bg-black min-h-[500px] md:min-h-[600px] overflow-hidden flex flex-col justify-end p-8 md:p-16">
            ...
            {/* 4. Content Content */}
            <div ref={displayRef} className="relative z-10">
              <div className="inline-block bg-tjm-yellow text-black px-3 py-1 text-[10px] font-black uppercase tracking-widest mb-6">
              ...
              <div
                className="absolute -bottom-10 -right-6 text-[18vw] font-montserrat font-black opacity-[0.07] pointer-events-none select-none italic text-tjm-yellow"
                style={{
